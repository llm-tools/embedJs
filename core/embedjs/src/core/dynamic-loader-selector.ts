...
import { isValidJson, isValidURL } from '@llm-tools/embedjs-utils';
import { CsvLoader } from '@llm-tools/embedjs-loader-csv';
import { WebLoader } from '@llm-tools/embedjs-loader-web';
import { YoutubeChannelLoader, YoutubeLoader, YoutubeSearchLoader } from '@llm-tools/embedjs-loader-youtube';
    ...
    public static async createLoader(loader: LoaderParam): Promise<BaseLoader> {
        ...
        if (loader.type) {
            ...
            switch (loader.type) {
                ...
                default:
                    throw new SyntaxError(`Unknown loader type ${(<{ type: string }>loader).type}`);
            }
        }
