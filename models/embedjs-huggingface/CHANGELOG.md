...
This was a version bump only for embedjs-huggingface to align it with other projects, there were no code changes.
...
-   The package now supports running embedding models based on HuggingFace Inference API
