...
<ParamField path="setQueryTemplate" type="string">
    This allows you to customize the system message used when querying the LLM. The system message is included with every call to the LLM besides the user query and chat history.
</ParamField>
